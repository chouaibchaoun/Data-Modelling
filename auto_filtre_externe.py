...
out = str(input("entrer le nom du fichier de sortie :"))
...
L = [2 , 1.90 , 1.80 , 1.70 , 1.65 , 1.60 , 1.55 , 1.50,1.45,1.40,1.35,1.30,1.27,1.24,1.20,1.17,1.14,1.10,1.07,1.03,1.00,0.97,0.94,0.90,0.87,0.84,0.80,0.77,0.74,0.70,0.67,0.64,0.60,0.55,0.50,0.45,0.40,0.35,0.33,0.30,0.28 , 0.25 , 0.23 ]
...
x = pd.read_csv("2015_Ext_Doux.csv"  ) #uploading data
